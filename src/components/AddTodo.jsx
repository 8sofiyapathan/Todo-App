...
const AddTodo = () => {
  ...
  return (
    <div className='addtodo-container'>
      <div>
      <input  className='todo-input' type="text" name="todoinput" id="todoinput" placeholder='Add Todo Here' value={todoInput} onChange={(e)=>setTodoInput(e.target.value)} ref = {inpbox}/>
